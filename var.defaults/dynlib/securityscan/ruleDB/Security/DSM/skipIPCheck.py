...
class RuleDictResult(DictResult):
    ...
    def getStatus(self):
        ...
        return SZ_PASS if not resp["data"]["skip_ip_checking"] else SZ_FAIL
    ...
    def getAction(self):
		...
		action[ACTION_REPLACE_VAR]['%1'] = "_T('dsmsetting', 'disable_session_srcip')"
		return action
