...
class PHPExcel_Reader_OOCalc extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
    ...
    /* SYNO start */
    private $styleDisabled = false;

    public function setDisableStyle($pValue = true) {
        $this->styleDisabled = $pValue;
    }
    /* SYNO end */
...
//        }
        ...
        if ($zip->open($pFilename) === true) {
            ...
            $zip->close();
            /***SYNO start***/
	    return ($mimeType === 'application/vnd.oasis.opendocument.spreadsheet') || ('application/vnd.oasis.opendocument.spreadsheet-template');
	    /***SYNO end***/
        }
...
//                                    echo 'Value Type is '.$cellDataOfficeAttributes['value-type'].'<br />';
					    ...
					    /*** SYNO start ***/
					    if (isset($cellDataText->p) &&
						isset($cellDataText->p->span) &&
						isset($cellDataText->p->span->a)) {
						$dataValue = $cellDataText->p->span->a;
					    /*** SYNO end ***/
