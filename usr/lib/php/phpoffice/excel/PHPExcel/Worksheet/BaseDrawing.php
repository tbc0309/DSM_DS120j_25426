...
class PHPExcel_Worksheet_BaseDrawing implements PHPExcel_IComparable
{
    ...
    /***SYNO start***/
    protected $coordinates_end;
    protected $offsetX_end;
    protected $offsetY_end;
    /***SYNO end***/
    ...
    {
        return $this->coordinates_end;
    }

    public function setEndCoordinates($pValue = 'A1')
    {
        $this->coordinates_end = $pValue;
        return $this;
    }

    public function getEndOffsetX()
    {
        return $this->offsetX_end;
    }

    public function setEndOffsetX($pValue = 0)
    {
        $this->offsetX_end = $pValue;
        return $this;
    }

    public function getEndOffsetY()
    {
        return $this->offsetY_end;
    }

    public function setEndOffsetY($pValue = 0)
    {
        $this->offsetY_end = $pValue;
        return $this;
    }
    /***SYNO end***/
