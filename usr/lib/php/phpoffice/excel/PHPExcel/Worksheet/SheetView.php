...
class PHPExcel_Worksheet_SheetView
{
    ...
    {
        // 18.3.1.87: zero implies the automatic settings
        if (($pValue >= 10 && $pValue <= 400) || ($pValue === 0)) {
            $this->zoomScaleNormal = $pValue;
        } else {
            throw new PHPExcel_Exception("Scale must be between 10 to 400 or equal to 0");
        }
        return $this;
    }
