...
class PHPExcel_Style extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
    ...
    /*** SYNO start ***/
    public function setFill(PHPExcel_Style_Fill $fill)
    {
        $this->fill = $fill;
        return $this;
    }

    public function setAlignment(PHPExcel_Style_Alignment $alignment)
    {
        $this->alignment = $alignment;
        return $this;
    }

    public function setBorders(PHPExcel_Style_Borders $borders)
    {
        $this->borders = $borders;
        return $this;
    }

    public function setNumberFormat(PHPExcel_Style_NumberFormat $numberFormat)
    {
