...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
    ...
    /*** SYNO start ***/
    private static $allowInvalidTitle = false;
    private static $disableXfInheritance = false;
    /*** SYNO end ***/
   ...
   /**
    ...
    /*** SYNO start ***/
    public static function setAllowInvalidTitle($pValue = true)
    {
        self::$allowInvalidTitle = $pValue;
    }

    public static function setDisableXfInheritance($pValue = true)
    {
        self::$disableXfInheritance = $pValue;
    }
    /*** SYNO end ***/
   ...
   /**
    ...
    private static function checkSheetTitle($pValue)
    {
        ...
        /*** SYNO start ***/
        $newValue = str_replace(self::$invalidCharacters, '_', $pValue);
        if ($newValue !== $pValue) {
            if (self::$allowInvalidTitle === true) {
                $pValue = $newValue;
            } else {
        ...
        if (PHPExcel_Shared_String::CountCharacters($pValue) > 31) {
            /*** SYNO start ***/
            if (self::$allowInvalidTitle === true) {
                $pValue = PHPExcel_Shared_String::Substring($pValue, 0, 31);
            } else {
    ...
    private function createNewCell($pCoordinate)
    {
        ...
        /* SYNO start */
        if (self::$disableXfInheritance === false) {
